...
//esta función será la encargada de comprobar si existe el usuario en la base de datos
	public function nueva_sesion()
	{
		...
		*
		...
		nos envíe a logueado.php con una variable de sesión que llamaremos $_SESSION['nick'] a la que
    asignamos el valor del campo username de ese usuario en la base de datos, que sería como el home de nuestra página,
